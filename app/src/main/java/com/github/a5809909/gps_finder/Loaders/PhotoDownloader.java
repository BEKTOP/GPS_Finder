...
public class PhotoDownloader<T> extends HandlerThread {
    ...
    private PhotoDownloadListener<T> mPhotoDownloadListener;
Context context;
    public interface PhotoDownloadListener<T> {
        void onThumbnailDownloaded(T target, Bitmap bitmap);
    }

    public void setPhotoDownloadListener(PhotoDownloadListener<T> listener) {
        ...
        try {
            ...
            mResponseHandler.post(new Runnable() {
                public void run() {
                    ...
                    mRequestMap.remove(target);
                    mPhotoDownloadListener.onThumbnailDownloaded(target, bitmap);
                }
            });
